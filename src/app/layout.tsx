              ...
              <nav style={{ padding: '1rem' }}>
                <div style={{
                  ...
                  <div style={{ display: 'flex', gap: '1rem' }}>
                    <Link href="/" style={{ color: 'black', textDecoration: 'none' }}>Overview</Link>
                    <Link href="/add" style={{ color: 'black', textDecoration: 'none' }}>Play Bingo</Link>
                    <Link href="/settings" style={{ color: 'black', textDecoration: 'none' }}>Settings</Link>
                  </div>
                </div>
              </nav>
            </AppBar>
