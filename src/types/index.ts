...
export const SYMPTOMS: Symptom[] = [
  ...
  {
    id: "coldSensitivity",
    label: "Increased sensitivity to cold",
    hasSeverity: false,
  },
  ...
  {
    id: "muscleAches",
    label: "Muscle aches, tenderness and stiffness",
    hasSeverity: true,
  },
  { id: "jointPain", label: "Joint pain and stiffness", hasSeverity: true },
  {
    id: "menstrualIssues",
    label: "Irregular or excessive menstrual bleeding",
    hasSeverity: false,
  },
  { id: "depression", label: "Depression", hasSeverity: true },
  {
    id: "memoryIssues",
    label: "Problems with memory or concentration",
    hasSeverity: true,
  },
  {
    id: "thyroidSwelling",
    label: "Swelling of the thyroid (goiter)",
    hasSeverity: false,
  },
  ...
  {
    id: "enlargedTongue",
    label: "Enlargement of the tongue",
    hasSeverity: false,
  },
];
